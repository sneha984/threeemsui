...
import 'package:threeemsui/screens/hostedchitpers.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        backgroundColor: Colors.white,
          ...
          title: Padding(
            padding:  EdgeInsets.only(top: scrHeight*0.02,left: scrWidth*0.001),
            child: Text(
              "Chits",
              style: TextStyle(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            CustomPaint(
                                              ...
                                              painter: (index==0)?RPSCustomPainter():RCustomPainter(),
                                              child: Container(
                                                width: scrWidth*0.17,
                                                height: scrHeight*0.023,
                                                padding: EdgeInsets.only(left: scrWidth*0.01),
                                                child: Center(
                                                  child: (index==0)?Text("Published",style: TextStyle(color: Colors.white,
                                                    fontSize: scrWidth*0.027,fontFamily: 'Urbanist',fontWeight: FontWeight.w600
                                                  ),):Text("Draft",style: TextStyle(color: Colors.black,
                                                      fontSize: scrWidth*0.027,fontFamily: 'Urbanist',fontWeight: FontWeight.w600
                                                  ),),
                                                ),
                                              ),
