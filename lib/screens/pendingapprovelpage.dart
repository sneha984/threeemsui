...
import 'package:threeemsui/screens/approvepage.dart';
import 'package:threeemsui/screens/splashscreen.dart';

import '../themes.dart';
import 'customclip2.dart';

class PendingApprovelPage extends StatefulWidget {
  const PendingApprovelPage({Key? key}) : super(key: key);

  @override
  State<PendingApprovelPage> createState() => _PendingApprovelPageState();
}

class _PendingApprovelPageState extends State<PendingApprovelPage> {
  @override
                                      ...
                                      subtitle: Row(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              width:(index==0)? scrWidth * 0.15:scrWidth*0.1,
                                              height: scrHeight * 0.017,
                                              decoration: BoxDecoration(
                                                  color: (index == 0)
                                                      ? Color(0xff8391A1)
                                                      : (index==2)?Color(0xffF61C0D):Color(0xff02B558),
                                                  borderRadius:
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ApprovePage()));
